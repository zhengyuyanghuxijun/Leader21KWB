...
/** Category of additions for `<UtilFMDatabase>` class.
...
@interface UtilFMDatabase (UtilFMDatabaseAdditions)
...
/** The schema of the database.
 ...
 @return `UtilFMResultSet` of schema; `nil` on error.
