...
@class UtilFMStatement;

/** Represents the results of executing a query on an `<UtilFMDatabase>`.
...
@interface UtilFMResultSet : NSObject {
    UtilFMDatabase          *_parentDB;
    UtilFMStatement         *_statement;
...
/** `UtilFMStatement` used by result set. */

@property (atomic, retain) UtilFMStatement *statement;

///------------------------------------
/// @name Creating and closing database
///------------------------------------

/** Create result set from `<UtilFMStatement>`
 
 @param statement A `<UtilFMStatement>` to be performed
 
 @param aDB A `<UtilFMDatabase>` to be used
 
 @return A `UtilFMResultSet` on success; `nil` on failure
 */

+ (instancetype)resultSetWithStatement:(UtilFMStatement *)statement usingParentDatabase:(UtilFMDatabase*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(UtilFMDatabase *)newDb;
