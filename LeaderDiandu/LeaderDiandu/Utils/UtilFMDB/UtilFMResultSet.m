...
+ (instancetype)resultSetWithStatement:(UtilFMStatement *)statement usingParentDatabase:(UtilFMDatabase*)aDB {
    ...
    return UtilFMDBReturnAutoreleased(rs);
}
...
- (void)dealloc {
    ...
    UtilFMDBRelease(_columnNameToIndexMap);
...
- (NSDictionary*)resultDict {
    ...
    if (num_cols > 0) {
        ...
        return UtilFMDBReturnAutoreleased([dict copy]);
    }
    else {
