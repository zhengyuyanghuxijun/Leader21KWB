...
-(void)startDownloadTask
{
    ...
    [self addRequestHeader:@"X-Requested-By" value:app_Name];
...
//    });
    ...
    _progressTimer=[NSTimer scheduledTimerWithTimeInterval:0.4 target:self selector:@selector(monitorDownloadProgress:) userInfo:nil repeats:YES];
