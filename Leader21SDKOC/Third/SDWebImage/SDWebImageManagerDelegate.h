...
//用于区分下载完成与本地载入完成
//*/
- (void)webImageManager:(SDWebImageManager *)imageManager didFinishDownloadWithImage:(UIImage *)image forURL:(NSURL *)url userInfo:(NSDictionary *)info;
- (void)webImageManager:(SDWebImageManager *)imageManager didFinishDownloadWithImage:(UIImage *)image forURL:(NSURL *)url;
- (void)webImageManager:(SDWebImageManager *)imageManager didFinishDownloadWithImage:(UIImage *)image;
/*/
//*/
